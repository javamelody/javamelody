...
public class JavaMelodyAutoConfiguration {
  ...
  public FilterRegistrationBean monitoringFilter(JavaMelodyConfigurationProperties properties) {
    ...
    filter.setApplicationType(
        properties.getApplicationType() != null ? properties.getApplicationType() : DEFAULT_APPLICATION_TYPE);

    // Wrap the monitoring filter in the registration bean.
    registrationBean.setFilter(filter);
    registrationBean.setAsyncSupported(true);
    registrationBean.setName(properties.getFilterName() != null ? properties.getFilterName() : DEFAULT_FILTER_NAME);
