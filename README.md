...
[![Build Status](https://travis-ci.com/javamelody/javamelody.svg?branch=master)](https://travis-ci.com/javamelody/javamelody) | [![Report Status](https://api.report.ci/status/javamelody/javamelody/badge.svg?branch=master&level=cases&build=travis-ci)](https://api.report.ci/status/javamelody/javamelody?branch=master&build=travis-ci)
