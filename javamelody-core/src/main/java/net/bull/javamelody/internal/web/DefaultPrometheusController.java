...
/**
 * Generates the default prometheus metrics. 
 * 
 ...
 */
class DefaultPrometheusController extends PrometheusController {
	...
	DefaultPrometheusController(List<JavaInformations> javaInformations, Collector collector,
