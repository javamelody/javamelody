...
/**
 * Factory class which creates actual {@link RrdFfmBackend} objects.
 */
public class RrdFfmBackendFactory extends RrdFileBackendFactory {
	/**
	 * factory name, "FFM-JavaMelody".
	 */
	public static final String FACTORY_NAME = "FFM-JavaMelody";
	...
	public static void setSyncPeriod(int syncPeriod) {
		RrdFfmBackendFactory.syncPeriod = syncPeriod;
	}
	...
	protected RrdBackend open(String path, boolean readOnly) throws IOException {
		return new RrdFfmBackend(path, readOnly, syncPeriod);
	}
