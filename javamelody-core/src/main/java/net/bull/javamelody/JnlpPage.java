...
//		}
			...
			// first javamelody-swing file available on github
			// TODO publish newer javamelody-swing files on github an review code above
			jarFileUrl = "https://github.com/javamelody/javamelody/releases/download/javamelody-core-1.49.0/javamelody-swing-1.49.0.jar";
		}
		return jarFileUrl;
	}
}
