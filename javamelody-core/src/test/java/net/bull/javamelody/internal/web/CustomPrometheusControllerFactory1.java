 ...
 */
public class CustomPrometheusControllerFactory1 implements PrometheusControllerFactory {

	@Override
	public PrometheusController createController(PrintWriter out) {
		return new PrometheusController(out, "custom1_") {

			@Override
			public void report() throws IOException {
				printDouble(MetricType.GAUGE, "answer", "custom description", 42.0);
			}
		};
	}
